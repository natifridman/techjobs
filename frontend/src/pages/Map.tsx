...
// Custom marker icon - Google Maps style (red/coral)
            ...
            {cityData.map((city) => (
              ...
              >
                <Popup className="custom-popup">
                  <div className="p-1">
                    <h3 className="font-bold text-lg text-slate-900 mb-2">{city.city}</h3>
                    ...
                    <div className="max-h-32 overflow-y-auto">
                      <p className="text-xs text-slate-500 mb-1">Top companies:</p>
