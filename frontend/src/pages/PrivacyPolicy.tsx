  ...
  return (
    <div className="min-h-screen bg-warm-50 py-12">
      <div className="max-w-4xl mx-auto px-4">
        <Button asChild variant="ghost" className="mb-8 text-warm-600 hover:text-warm-900">
        ...
        <article className="bg-white rounded-2xl shadow-sm border border-warm-200 p-8 md:p-12">
          <div className="flex items-center gap-3 mb-2">
            <Shield className="w-10 h-10 text-iris-600" />
            <h1 className="text-4xl font-bold text-warm-900">Privacy Policy</h1>
          </div>
          <p className="text-warm-500 mb-8">Last updated: January 2026</p>
          ...
          <div className="prose prose-warm max-w-none">
            ...
            <section className="mb-8 bg-iris-50 border border-iris-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                <UserCircle className="w-6 h-6 text-iris-600" />
                <h2 className="text-2xl font-semibold text-warm-900">2. Google Sign-In</h2>
              </div>
              ...
              <ul className="list-disc list-inside text-warm-700 space-y-2 ml-4 mt-4">
            ...
            <section className="mb-8 bg-iris-50 border border-iris-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                <BarChart3 className="w-6 h-6 text-iris-600" />
                <h2 className="text-2xl font-semibold text-warm-900">3. Analytics & Service Improvement (PostHog)</h2>
              </div>
              <p className="text-warm-700 leading-relaxed">
              ...
              <ul className="list-disc list-inside text-warm-700 space-y-2 ml-4 mt-2">
            ...
            <section className="mb-8 bg-red-50 border border-red-200 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-semibold text-warm-900">4. Data Deletion</h2>
              </div>
              <p className="text-warm-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">5. Other Information We Collect</h2>
              <p className="text-warm-600 leading-relaxed mb-4">
                In addition to the above, we may collect:
              </p>
              <ul className="list-disc list-inside text-warm-600 space-y-2 ml-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">6. How We Use Your Information</h2>
              <p className="text-warm-600 leading-relaxed mb-4">
            ...
            {/* Information Sharing */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">7. Information Sharing</h2>
              <p className="text-warm-600 leading-relaxed">
                We do not sell your personal information. We may share your information only in the
                following circumstances:
              </p>
              <ul className="list-disc list-inside text-warm-600 space-y-2 ml-4 mt-4">
            ...
            {/* Data Security */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">8. Data Security</h2>
              <p className="text-warm-600 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">9. Cookies and Tracking</h2>
              <p className="text-warm-600 leading-relaxed">
            ...
            {/* Your Rights */}
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">10. Your Rights</h2>
              <p className="text-warm-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">11. Third-Party Services</h2>
              <p className="text-warm-600 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">12. Changes to This Policy</h2>
              <p className="text-warm-600 leading-relaxed">
            ...
            {/* Contact Us */}
            <section>
              <h2 className="text-2xl font-semibold text-warm-900 mb-4">13. Contact Us</h2>
              <p className="text-warm-600 leading-relaxed">
              ...
              <p className="mt-4">
                <a
                  href="mailto:techjobsil@googlegroups.com"
                  className="text-iris-600 hover:text-iris-700 underline font-medium"
                >
                  techjobsil@googlegroups.com
                </a>
              </p>
